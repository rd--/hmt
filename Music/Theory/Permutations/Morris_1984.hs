...
>>> map parse_change ["-","x","38"]
[Swap_All,Swap_All,Hold [3,8]]
-}
...
Method [Swap_All,Hold [3,8],Swap_All,Hold [1,4],Swap_All,Hold [1,2,5,8],Swap_All,Hold [3,6],Swap_All,Hold [1,4],Swap_All,Hold [5,8],Swap_All,Hold [1,6],Swap_All,Hold [7,8]] (Just [Hold [1,2]])
-}
...
>>> map int_to_nchar [3,8,10,11,12,13]
"380ETA"
-}
...
>>> gen_swaps 8 [3,8]
[Right (1,2),Left 3,Right (4,5),Right (6,7),Left 8]

>>> gen_swaps 8 [1,2]
[Left 1,Left 2,Right (3,4),Right (5,6),Right (7,8)]
-}
...
>>> swaps_to_cycles [Left 1,Left 2,Right (3,4),Right (5,6),Right (7,8)]
[[1],[2],[3,4],[5,6],[7,8]]
-}
...
>>> to_zero_indexed [[1],[2],[3,4],[5,6],[7,8]]
[[0],[1],[2,3],[4,5],[6,7]]
-}
...
>>> swap_abbrev 8 [3,8] [2,1,4,3,6,5,8,7]
[1,2,4,6,3,8,5,7]
-}
...
>>> apply_method cambridgeshire_slow_course_doubles [1..5]
([1,2,4,5,3],[[1,2,3,4,5],[2,1,3,4,5],[2,3,1,4,5],[3,2,4,1,5],[3,4,2,5,1],[4,3,2,5,1],[4,2,3,1,5],[2,4,1,3,5],[2,1,4,3,5],[1,2,4,3,5]])
-}
...
>>> length (closed_method cambridgeshire_slow_course_doubles [1..5])
3
-}
...
>>> length (closed_place cambridgeshire_place_doubles_pl [1..5])
3
-}
...
>>> length (closed_place double_cambridge_cyclic_bob_minor_pl [1..6])
5
-}
...
>>> length (closed_place hammersmith_bob_triples_pl [1..7])
6
-}
...
>>> length (closed_place cambridge_surprise_major_pl [1..8])
7
-}
...
>>> (length c,nub (map length c),sum (map length c))
(9,[40],360)
-}
...
>>> let c = closed_place ecumenical_surprise_maximus_pl [1..12]
>>> (length c,nub (map length c),sum (map length c))
(11,[48],528)
-}
