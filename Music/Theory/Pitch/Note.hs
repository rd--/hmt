...
>>> map note_to_pc [C,E,G]
[0,4,7]
-}
note_to_pc :: Num i => Note -> i
note_to_pc n = List.lookup_err_msg "note_to_pc" n note_pc_tbl
...
>>> map alteration_to_diff [Flat,QuarterToneSharp]
[Just (-1),Nothing]
-}
...
>>> map alteration_to_diff_err [Flat,Sharp]
[-1,1]
-}
...
>>> alteration_to_fdiff QuarterToneSharp
0.5
-}
...
>>> alteration_raise_quarter_tone Flat
Just QuarterToneFlat

>>> alteration_raise_quarter_tone DoubleSharp
Nothing
-}
...
>>> alteration_lower_quarter_tone Sharp
Just QuarterToneSharp

>>> alteration_lower_quarter_tone DoubleFlat
Nothing
-}
...
and <http://lilypond.org/doc/v2.16/Documentation/notation/writing-pitches>

>>> map alteration_tonh [Flat .. Sharp]
["es","eh","","ih","is"]
-}
alteration_tonh :: Alteration -> String
alteration_tonh a = List.lookup_err a alteration_tonh_tbl
...
>>> map (Parse.run_parser_error p_note_t . return) "ABCDEFG"
[A,B,C,D,E,F,G]
-}
...
>>> map (Parse.run_parser_error (p_alteration_t_iso False)) (words "bb b # x ##")
[DoubleFlat,Flat,Sharp,DoubleSharp,DoubleSharp]
-}
p_alteration_t_iso :: Bool -> Parse.P Alteration
p_alteration_t_iso strict = fmap (symbol_to_alteration_iso_err strict) (Parsec.many (Parsec.oneOf "b#x"))

{- | Parser for tonh alteration

>>> map (Parse.run_parser_error p_alteration_t_tonh) ["eses","es","is","isis"]
[DoubleFlat,Flat,Sharp,DoubleSharp]
-}
p_alteration_t_tonh :: Parse.P Alteration
p_alteration_t_tonh = fmap tonh_to_alteration_err (Parsec.many1 (Parsec.oneOf "ehis"))
