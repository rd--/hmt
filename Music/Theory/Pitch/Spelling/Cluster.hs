...
>>> cluster_normal_order_octpc 3 [0,1,11]
[(3,11),(4,0),(4,1)]
-}
...
>>> map cluster_is_multiple_octave [[0,1,11],[1,2,3],[1,2,11]]
[True,False,True]
-}
...
>>> let f (p,q) = (p == map Pitch.Note.note_alteration_to_pc_err q)
...
>>> fmap (map Pitch.pitch_pp_iso) (spell_cluster_octpc [(3,11),(4,3),(4,11),(5,1)])
Just ["B3","D#4","B4","C#5"]
-}
...
>>> let f = (fmap (map Pitch.pitch_pp) . spell_cluster_c4)
>>> map f [[11,0],[11],[0,11]]
