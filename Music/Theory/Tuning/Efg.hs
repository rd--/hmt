...
>>> let r = Data.List.sort $ map snd $ efg_ratios 7 [(3,3),(7,2)]
>>> r
[1 % 1,9 % 8,8 % 7,9 % 7,21 % 16,189 % 128,3 % 2,27 % 16,12 % 7,7 % 4,27 % 14,63 % 32]

>>> map (round . Tuning.ratio_to_cents) r
...
>>> let r' = Data.List.sort $ map snd $ efg_ratios 5 [(5,2),(7,3)]
>>> r'
[1 % 1,343 % 320,35 % 32,49 % 40,5 % 4,343 % 256,7 % 5,49 % 32,8 % 5,1715 % 1024,7 % 4,245 % 128]

>>> map (round . Tuning.ratio_to_cents) r'
[0,120,155,351,386,506,583,738,814,893,969,1124]

>>> let r'' = Data.List.sort $ map snd $ efg_ratios 3 [(3,1),(5,1),(7,1)]
>>> r''
[1 % 1,35 % 32,7 % 6,5 % 4,4 % 3,35 % 24,5 % 3,7 % 4]
...
-}
efg_diagram_set :: (Enum n, Real n) => (Tuning.Cents -> n, n, n, n) -> [Efg n] -> [(n, n, n, n)]
efg_diagram_set (to_f, h, m, k) e =
  let f = (++ [1200]) . Data.List.sort . map (to_f . Tuning.ratio_to_cents . snd) . efg_ratios 1
      g (c, y) =
        let y' = y + h
