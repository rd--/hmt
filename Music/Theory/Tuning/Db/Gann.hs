...
>>> map round pietro_aaron_1523_c
[0,76,193,310,386,503,580,697,773,890,1007,1083]
-}
...
>>> tn_cents_i pietro_aaron_1523
[0,76,193,310,386,503,580,697,773,890,1007,1083]

>>> import Music.Theory.Tuning.Scala
>>> scl <- scl_load "meanquar"
>>> tn_cents_i (scale_to_tuning scl)
...
>>> tn_divisions zarlino_1588
16

>>> tn_cents_i zarlino_1588
[0,71,182,204,294,316,386,498,569,590,702,773,884,996,1018,1088]
...
>>> map (round . ratio_to_cents) ben_johnston_mtp_1977_r
[0,105,204,298,386,471,551,702,841,906,969,1088]
-}
...
>>> tn_cents_i ben_johnston_mtp_1977
[0,105,204,298,386,471,551,702,841,906,969,1088]
-}
...
>>> tn_cents_i gann_arcana_xvi
[0,84,112,204,267,316,347,386,471,498,520,583,663,702,734,814,845,884,898,969,1018,1049,1088,1161]
-}
...
>>> tn_divisions gann_superparticular
22

>>> tn_cents_i gann_superparticular
[0,165,182,204,231,267,316,386,435,498,551,583,617,702,782,765,814,884,933,969,996,1018]
