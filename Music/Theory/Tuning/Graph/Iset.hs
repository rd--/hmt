...
-- | Does [F] construct indicated /pcset/.
r_is_pcset :: [Int] -> [F] -> Bool
...
g_to_dot :: Int -> [(String,String)] -> (F -> [(String,String)]) -> G -> [String]
...
mk_graph_scl :: [F] -> Scala.Scale -> G
mk_graph_scl iset = mk_graph iset . rem_oct . Scala.scale_ratios_req True

scl_to_dot :: ([F], Int, [(String, String)], F -> [(String, String)]) -> String -> IO [String]
