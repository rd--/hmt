...
{- | Plomp-Levelt consonance curve, (f, v) = (frequency, amplitude).
...
>>> map fst (local_minima (atms_fig_2 880))
[204,231,267,316,386,435,498,583,702,814,884,969,1018]
-}
...
>>> map fst (local_minima (atms_fig_3 880))
[267,400,533,667,800,933,1043]
-}
...
>>> map fst (local_minima (rtt_fig_2 880))
[218,267,316,386,498,582,702,884,969,1023]
-}
