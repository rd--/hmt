...
> chn_t0 mod12 3 [0,2,4,5,7,9] == [[5,7,9,10,0,2],[5,7,9,4,6,8]]

>>> echo 02457t | pct chn T0 2
7A0135 (RT5I)
7A81B9 (RT9MI)

> chn_t0 mod12 2 [0,2,4,5,7,10] == [[7,10,0,1,3,5],[7,10,8,1,11,9]]
...
> ciseg mod12 [0,1,4,2,9,5,11,3,8,10,7,6] == [1,3,10,7,8,6,4,5,2,9,11,6]
...
-- 13579B
--
-- > cmpl mod12 [0,2,4,6,8,10] == [1,3,5,7,9,11]
...
dim p =
    let g (i,q) = is_subset p (z_tto_tn mod12 i q)
...
-- > doi mod12 6 p p == [[0,2,4,5,7,9,10],[0,2,4,6,7,9,11]]
--
-- >>> echo 01234 | pct doi 2 7-35 | sort -u
-- 13568AB
--
-- > doi mod12 2 (sc "7-35") [0,1,2,3,4] == [[1,3,5,6,8,10,11]]
...
-- 923507A
--
-- > ess mod12 [0,1,6,4,3,2,5] [2,3,10] == [[9,2,3,5,0,7,10],[2,11,0,1,3,10,9]]
...
-- > has_sc mod12 d (z_complement mod12 d) == True
--
-- > has_sc mod12 [] [] == True
...
> spsc mod12 [sc "4-11",sc "4-12"] == [[0,2,4,5,8]]

>>> pct spsc 3-11 3-8
4-27[0258]
4-Z29[0137]

> spsc mod12 [sc "3-11",sc "3-8"] == [[0,2,5,8],[0,1,3,7]]

>>> pct spsc `pct fl 3`
6-Z17[012478]

> spsc mod12 (cf [3] scs) == [[0,1,2,4,7,8]]
...
> tmatrix mod12 [1,2,5,8] == [[1,2,5,8],[0,1,4,7],[9,10,1,4],[6,7,10,1]]
...
> sort (trs mod12 [0,2,4,5,7,9] [6,4,2]) == r
...
--
-- > trs_m mod12 [0,2,4,5,7,9] [6,4,2] == [[6,4,2,1,11,9],[11,9,7,6,4,2]]
