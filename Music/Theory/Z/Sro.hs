...
>>> let s = zip (map sro_pp u) (map (\o -> z_sro_apply z12 o [0,1,3]) u)
>>> length s
288
-}
...
>>> z_sro_apply z12 (Sro 1 True 1 5 False) [0,1,2,3]
[11,6,1,4]

>>> z_sro_apply z12 (Sro 1 False 4 5 True) [0,1,2,3]
[11,6,1,4]
-}
...
>>> z_sro_invert z5 0 [0,1,4]
[0,4,1]

>>> z_sro_invert z12 6 [4,5,6]
[8,7,6]
...
>>> z_sro_tni z5 1 [0,1,3]
[1,0,3]

>>> z_sro_tni z12 4 [1,5,6]
[3,11,10]

>>> (z_sro_invert z12 0 . z_sro_tn z12 4) [1,5,6]
[7,3,2]
-}
...
>>> length (z_sro_t_related z12 [0,3,6,9])
12

>>> z_sro_t_related z5 [0,2]
[[0,2],[1,3],[2,4],[3,0],[4,1]]
-}
...
>>> length (z_sro_ti_related z12 [0,1,3])
24

>>> length (z_sro_ti_related z12 [0,3,6,9])
24
...
>>> length (z_sro_rti_related z12 [0,1,3])
48

>>> length (z_sro_rti_related z12 [0,3,6,9])
24
-}
...
>>> z_sro_tn_to z12 5 [0,1,3]
[5,6,8]

>>> map (z_sro_tn_to z12 0) [[0,1,3],[1,3,0],[3,0,1]]
[[0,1,3],[0,2,11],[0,9,10]]
-}
...
>>> map (z_sro_invert_ix z12 0) [[0,1,3],[3,4,6]]
[[0,11,9],[3,2,0]]

>>> map (z_sro_invert_ix z12 1) [[0,1,3],[3,4,6]]
[[2,1,11],[5,4,2]]
-}
