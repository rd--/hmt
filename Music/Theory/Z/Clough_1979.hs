...
>>> map dpcset_to_chord [[0,1],[0,2,4],[2,3,4,5,6]]
[[1,6],[2,2,3],[1,1,1,1,3]]
-}
...
>>> map dpcset_complement [[0,1],[0,2,4]]
[[2,3,4,5,6],[1,3,5,6]]
-}
...
>>> map complement [[1,6],[2,5],[3,4],[1,1,5],[1,2,4],[1,3,3],[2,2,3]]
[[1,1,1,1,3],[1,1,1,2,2],[1,1,2,1,2],[1,1,1,4],[2,1,1,3],[1,2,1,3],[1,2,2,2]]
-}
...
>>> map iseq (permutations [0,1,2])
[[1,1],[6,2],[6,6],[1,5],[5,1],[2,6]]

>>> map iseq (permutations [0,1,3])
[[1,2],[6,3],[5,6],[2,4],[4,1],[3,5]]

>>> map iseq (permutations [0,2,3])
[[2,1],[5,3],[6,5],[1,4],[4,2],[3,6]]

>>> map iseq (permutations [0,1,4])
[[1,3],[6,4],[4,6],[3,3],[3,1],[4,4]]

>>> map iseq (permutations [0,2,4])
[[2,2],[5,4],[5,5],[2,3],[3,2],[4,5]]
-}
iseq :: Integral n => [n] -> [n]
