...
>>> map inv_sym (Forte.scs_n 2)
[True,True,True,True,True,True]

>>> map (fromEnum.inv_sym) (Forte.scs_n 3)
...
the class providing the /best normal order/ (Forte 1973) is always the @A@ class.
If neither @A@ nor @B@ appears in the name of a set-class, it is inversionally symmetrical.

>>> (length Forte.sc_table,length t_sc_table)
(224,352)
...
>>> map (length . t_scs_n) [2..10]
[6,19,43,66,80,66,43,19,6]
-}
...
>>> t_subsets [0,1,2,3,4] [0,1]
[[0,1],[1,2],[2,3],[3,4]]

>>> t_subsets [0,1,2,3,4] [0,1,4]
[[0,1,4]]

>>> t_subsets [0,2,3,6,7] [0,1,4]
[[2,3,6]]
-}
...
>>> ti_subsets [0,1,2,3,4] [0,1]
[[0,1],[1,2],[2,3],[3,4]]

>>> ti_subsets [0,1,2,3,4] [0,1,4]
[[0,1,4],[0,3,4]]

>>> ti_subsets [0,2,3,6,7] [0,1,4]
[[2,3,6],[3,6,7]]
-}
...
>>> t_n_class_vector 2 [0..4]
[4,3,2,1,0,0]

>>> rle (t_n_class_vector 3 [0..4])
[(1,3),(2,2),(2,1),(4,0),(1,1),(9,0)]

>>> rle (t_n_class_vector 4 [0..4])
[(1,2),(3,1),(39,0)]
-}
...
>>> ti_n_class_vector 2 [0..4]
[4,3,2,1,0,0]

>>> ti_n_class_vector 3 [0,1,2,3,4]
[3,4,2,0,0,1,0,0,0,0,0,0]

>>> rle (ti_n_class_vector 4 [0,1,2,3,4])
[(2,2),(1,1),(26,0)]
-}
...
>>> dyad_class_percentage_vector [0,1,2,3,4]
[40,30,20,10,0,0]

>>> dyad_class_percentage_vector [0,1,4,5,7]
[20,10,20,20,20,10]
-}
