...
-- | Lookup MIDI velocity for 'Dynamic_Mark'.  The range is linear
-- in @0-127@.
--
...
-- | Translate /fixed/ 'Dynamic_Mark's to /db/ amplitude over given
-- /range/.
--
...
-- | Variant of 'dynamic_sequence' for sequences of 'Dynamic_Mark'
...
-- | Apply 'Hairpin' and 'Dynamic_Mark' functions in that order as
